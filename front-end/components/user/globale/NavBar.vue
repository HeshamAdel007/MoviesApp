<template lang="pug" scoped>
  nav.border-b.border-gray-800
    .container.mx-auto.px-4.flex.items-center.justify-between.px-4.py-2(class="md:flex-row")
      ul.flex.items-center(class="md:flex-row")
        NuxtLink.ml-6(to="/" tag="li")
          a
            svg.w-32(viewbox='0 0 96 24' fill='none')
        ...
        NuxtLink.ml-6(to="/" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") home
        NuxtLink.ml-6(to="/actor" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") actor
        NuxtLink.ml-6(to="/category" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") category
        NuxtLink.ml-6(to="/contactus" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") countact us
        NuxtLink.ml-6(to="/auth/login" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") login
        NuxtLink.ml-6(to="/auth/register" tag="li" class="md:ml-6 md:mt-0")
          a(class="hover:text-gray-300") register
      .flex.items-center(class="md:flex-row")
        .mt-3(class="md:ml-4 md:mt-0")
          form(@submit.prevent="searchPost")
            input(type="search" v-model="search" name="search" class="bg-gray-800 text-sm rounded-full w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Search...")
</template>
